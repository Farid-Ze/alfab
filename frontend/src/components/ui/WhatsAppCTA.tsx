 ...
 * Primary conversion action per paket-a.md.
...
export function WhatsAppCTA({
    ...
    const wa = translations.whatsapp as { ariaLabel: string; chatLabel: string };
    ...
    return (
        <motion.a
            ...
            className={cn(
                ...
                "hover:bg-[#20BD5A] hover:shadow-xl",
                "transition-all duration-200",
                showLabel ? "px-4 py-3" : "p-3 md:p-4",
