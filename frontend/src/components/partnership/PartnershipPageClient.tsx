...
export default function PartnershipPageClient() {
  ...
  const businessTypeLabel = (type: SalonType) => {
              ...
              <>
                ...
                <div className="p-6 rounded-2xl bg-panel shadow-elegant-box">
                  ...
                  <dl className="space-y-2 type-body text-foreground-muted">
                    ...
                    <div><span className="text-muted">{tx.partnership.form.step1.businessType}:</span> {values.salonType ? businessTypeLabel(values.salonType) : ""}</div>
