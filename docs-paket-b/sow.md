...
1. **Identity & Access Module:** Pengembangan sistem login bertingkat (Guest, Partner, Agent, Admin) dengan protokol keamanan *Impersonation* (Shadow Mode). *Sub-Distributor tidak memiliki akun login - hanya data contact untuk routing.*
...
4. **Admin SLA Dashboard:** Monitoring order yang di-route ke SubDist, SLA status, dan escalation. *SubDist menerima order via WhatsApp Deep Link - tidak ada dashboard SubDist.*
...
Investasi dihitung berdasarkan *Resource Loading* dari WBS V2.5 (Total Effort: **161.5 Man-Days**).
...
| --- | --- | --- | --- |
| **Backend Engineering** | 62.25 Man-Days | Rp 135.000 | Rp 8.403.750 |
| **Frontend Engineering** | 39.75 Man-Days | Rp 135.000 | Rp 5.366.250 |
| **DevOps & Infra** | 12.5 Man-Days | Rp 135.000 | Rp 1.687.500 |
...
| **Subtotal Services** | **161.5 Man-Days** |  | **Rp 21.802.500** |
...
2. **WhatsApp Sub-Distributor:** Klien menyediakan daftar nomor WhatsApp Sub-Distributor untuk digunakan dalam Deep Link routing. **Tidak diperlukan integrasi WhatsApp Business API (WABA)** - sistem menggunakan Deep Link (`wa.me/...?text=...`).
